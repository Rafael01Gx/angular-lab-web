...
@Component({
  ...
  template: `
    <div
      class="bg-white flex flex-col rounded-md shadow-sm border border-gray-200 w-full h-full min-h-0 "
    >
      <!-- Table Container -->
              ...
              >
                ...
                <td class="px-6 py-4 whitespace-nowrap">
                  <div class="flex items-center space-x-3">
                    ...
                    <span
                      class="text-sm font-medium text-gray-700 min-w-[40px]"
                    >
                      {{ ordem.progresso || 0 }}%
                    </span>
                  </div>
                ...
                <!-- Actions Column -->
                <td
                  class="px-6 py-4 flex justify-end items-center gap-2 whitespace-nowrap"
                >
                  @if (impressao()) {
                  <button
                  ...
                  >
                    <ng-icon name="heroPrinter" class="mr-2" />
                    Etiqueta
                  </button>
                  } @if (cancelarOs()) {
                  <button
                        ...
                        <div class="space-y-2 text-sm">
                          <div class="flex justify-between">
                            ...
                            <span class="text-gray-900">{{
                              (ordem.dataRecepcao | date : 'mediumDate') ||
                                'Não Recepcionado!'
                            }}</span>
                          </div>
                          <div class="flex justify-between">
                    ...
                    >
                      ...
                      <div class="divide-y divide-gray-200">
                        ...
                        >
                              ...
                              <div class="flex items-center space-x-2">
                                ...
                                >
                                  <div
                                    ...
                                    [class]="
                                      getProgressBarClass(amostra.progresso)
                                    "
                                    [style.width.%]="amostra.progresso || 0"
                                  ></div>
                                </div>
                                <span
                                  class="text-xs text-gray-600 min-w-[30px]"
                                >
                                  {{ amostra.progresso || 0 }}%
                                </span>
                              </div>
                          ...
                          <div
                            class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-3 text-xs"
                          >
                            <div>
                              <span class="text-gray-500">Data Amostra:</span>
                              <div class="text-gray-900 font-medium">
                                {{ amostra.dataAmostra | date : 'mediumDate' }}
                              </div>
                            </div>
                            <div>
...
export class OrdemServicoTableComponent {
  ...
  calcularProgresso(data: IOrders[]): IOrders[] {
    return data.map((ordem) => {
      ...
      const amostrasConcluidas = ordem.amostras.filter(
        (amostra) => amostra.status === Status.FINALIZADA
      ).length;
      const progresso = totalAmostras
        ? Math.round((amostrasConcluidas / totalAmostras) * 100)
        : 0;
