export const calcularPrazoEmDias = (dataPrazo: string): string => {
...
export const limitarCasasDecimais = (
...
export const transformarResultado = (
  value: number | string,
  casasDecimais: number
): string => {
...
export const getMonthAndWeek = (weekNumber: string | number) => {
